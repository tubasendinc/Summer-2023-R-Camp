...
If your intention is to generate PDF documents from R Markdown, we must have a LaTeX distribution installed. While there are several conventional choices available, such as MiKTeX, MacTeX, and TeX Live, we can also install TinyTeX using the following code:
